...
const Selection = ({ render, setRender }: any) => {
  return (
    <div className="sectionCards" /* style={{ display: "flex", alignItems: "center", justifyContent: "center" }} */>
      ...
      <div className="section">
        <Card title="Flashcards" text="Elevate learning with interactive flashcards for easy review and retention. Dynamic and engaging, they enhance understanding and memorization for exams, presentations, and reinforcing knowledge." onClick={() => setRender("flashcards")}/>
